...
const Contactform = () => {
  ...
  return (
    <form className=' d-flex flex-column align-content-center gap-3 px-4 pt-4 mt-5 ' onSubmit={handleSubmit} id='createauthform'>
      ...
      <div className="d-lg-flex flex-column gap-4 d-md-flex">
